---
layout: default
title: Tiation Rigger Connect Api - Enterprise Solution
...
<div class="tiation-hero">
  ...
  <div class="hero-content">
    ...
    <h1 class="hero-title">
      ...
      <span class="gradient-text">Tiation Rigger Connect Api</span>
    </h1>
    ...
    <div class="hero-cta">
      ...
      <a href="https://github.com/tiation/tiation-rigger-connect-api" class="btn-tertiary">📁 View Code</a>
    </div>
  </div>
</div>
...
```bash
# Build Docker image
docker build -t tiation-rigger-connect-api .

# Run container
docker run -p 8080:8080 tiation-rigger-connect-api
```
...
### 📞 Getting Help
- **📚 Documentation**: [Full documentation](https://tiation.github.io/tiation-rigger-connect-api)
- **❓ FAQ**: [Frequently asked questions](faq.md)
- **🐛 Issues**: [GitHub Issues](https://github.com/tiation/tiation-rigger-connect-api/issues)
- **💬 Discussions**: [GitHub Discussions](https://github.com/tiation/tiation-rigger-connect-api/discussions)
